...
class _HomePageState extends State<HomePage>
  ...
  void didChangeDependencies() {
    ...
    _reactionDisposers ??= [
      reaction((_) => _homePageStore.operacaoRealizada, (String operacao) {
        _homePageStore.alternarExibirBottonNavigationBar();
        ScaffoldMessenger.of(context)
            ...
            .closed
            .then(
                (value) => _homePageStore.alternarExibirBottonNavigationBar());
      })
    ];
  }
